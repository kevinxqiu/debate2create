...
class Walker2d(PipelineEnv):
  ...
  def __init__(
    ...
    # n_frames set above; reward_fn handled by this subclass
  ...
  def step(self, state: State, action: jax.Array) -> State:
    ...
    obs = self._get_obs(pipeline_state)
    base_reward = forward_reward + healthy_reward - ctrl_cost
    ...
    if getattr(self, "_use_custom_reward", False):
      ...
      joint_angles = pipeline_state.q[2:7]  # matches original reward usage
